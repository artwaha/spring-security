...
public interface PatientApi {
    ...
    @RequestMapping(value = "/internal/patient/regno", method = RequestMethod.GET, produces = "application/json")
    ...
    @RequestMapping(value = "/internal/patient/mobile", method = RequestMethod.PUT, produces = "application/json")
